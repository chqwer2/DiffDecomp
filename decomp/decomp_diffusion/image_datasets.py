...
def get_dataset(dataset_type, base_dir, start_index=0, num_images=None, resolution=64):
    ...
    if dataset_type in DATASET_MAPPING:
        ...
        # opt, basedir, modality,
        data_dir = "/bask/projects/j/jiaoj-rep-learn/Hao/medical/Dataset" + "/Brain"
        domains = ["BraTS-GLI-T1C"]  # ["BraTS-SSA-T1C", "BraTS-PED-T1C"]
        dataset = BrainDataset(mode="train", basedir=data_dir, modality=domains, resolution=resolution)
    else:    
