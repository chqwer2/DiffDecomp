...
def get_albu_transforms(img_size = (192, 192)):
    ...
    return A.Compose([
        ...
        A.ShiftScaleRotate(shift_limit=0.0625, scale_limit=(-0.1, 0.1), rotate_limit=5, p=0.5),
        ...
        # A.CoarseDropout(max_holes=3, max_height=img_size[0] // 20, max_width=img_size[1] // 20,
