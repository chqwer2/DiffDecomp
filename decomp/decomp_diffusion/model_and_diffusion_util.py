...
def create_gaussian_diffusion(steps=1000, noise_schedule="squaredcos_cap_v2", predict_xstart=True, loss_mode="mae"):
    betas = get_named_beta_schedule(noise_schedule, steps)
    gd = GaussianDiffusion(betas, predict_xstart=predict_xstart, loss_mode=loss_mode)
    return gd
