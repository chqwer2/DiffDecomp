#python defading-diffusion-pytorch/test.py --time_steps 50 --save_folder ./cifar_inpainting_test --discrete --sampling_routine x0_step_down --blur_std 0.1 --fade_routine Random_Incremental --test_type test_paper_invert_section_images
